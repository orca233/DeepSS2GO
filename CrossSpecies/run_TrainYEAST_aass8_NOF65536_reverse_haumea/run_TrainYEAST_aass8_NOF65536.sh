...
echo ------s2_TrainTest_TrainYEAST_TestYEAST_ss8_NOF65536_reverse------
cd ../s2_TrainTest_TrainYEAST_TestYEAST_ss8_NOF65536_reverse || exit
python run_KernelX_FilterY.py


echo ------s2_TrainTest_TrainYEAST_TestYEAST_aa_NOF65536_reverse------
cd ../s2_TrainTest_TrainYEAST_TestYEAST_aa_NOF65536_reverse || exit
python run_KernelX_FilterY.py

echo ------s2_TrainTest_TrainYEAST_TestMYCTU_ss8_NOF65536_reverse------
cd ../s2_TrainTest_TrainYEAST_TestMYCTU_ss8_NOF65536_reverse || exit
python run_KernelX_FilterY.py

echo ------s2_TrainTest_TrainYEAST_TestMYCTU_aa_NOF65536_reverse------
cd ../s2_TrainTest_TrainYEAST_TestMYCTU_aa_NOF65536_reverse || exit
python run_KernelX_FilterY.py
