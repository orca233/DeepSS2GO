...
cd ../s2_TrainTest_TrainMOUSE_TestMYCTU_aa || exit
python run_KernelX_FilterY.py

echo ------s2_TrainTest_TrainMOUSE_TestMYCTU_ss8------
cd ../s2_TrainTest_TrainMOUSE_TestMYCTU_ss8 || exit
python run_KernelX_FilterY.py



echo ------s2_TrainTest_TrainMOUSE_TestYEAST_aa------
cd ../s2_TrainTest_TrainMOUSE_TestYEAST_aa || exit
python run_KernelX_FilterY.py

echo ------s2_TrainTest_TrainMOUSE_TestYEAST_ss8------
cd ../s2_TrainTest_TrainMOUSE_TestYEAST_ss8 || exit
python run_KernelX_FilterY.py
