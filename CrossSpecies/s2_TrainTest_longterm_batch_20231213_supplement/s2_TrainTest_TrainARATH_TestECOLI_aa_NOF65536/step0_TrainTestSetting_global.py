...
params_global_constant = {
    ...
    'dir0': 'test_TrainARATH_TestECOLI_aa/',  # output/dir0/ 同一批次实验的root文件夹， change -----
...
params_global_dynamic = {
    ...
    'kernels': [8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128],  # 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112,
