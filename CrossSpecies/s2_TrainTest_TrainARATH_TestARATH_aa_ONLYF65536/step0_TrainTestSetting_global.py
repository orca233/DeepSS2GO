...
params_global_constant = {
    ...
    'train_data': 'ARATH',  #  只写具体物种 HUMAN, MOUSE, ARATH。。。，不用写ALL00， ['HUMAN', 'MOUSE']
    'test_data': 'ARATH',  # ['HUMAN', 'MOUSE']


    # 文件夹
    # dir0 = 是“非变量，不参与循环”       dir1 = 变量，参与循环
    'dir0': 'test_TrainARATH_TestARATH_aa/',  # output/dir0/ 同一批次实验的root文件夹， change -----
...
params_global_dynamic = {
    ...
    'kernels': [8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128],  # 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120,
    'filters': [65536]   # 不需要变成 tuple
