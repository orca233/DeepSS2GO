...
params_global_constant = {
    ...
    'dir0': 'test_TrainHUMAN_TestHUMAN_ss8_FC2/',  # output/dir0/ 同一批次实验的root文件夹， change -----
    ...
    'FC_depth': 2,  # 替换为所需的全连接层深度, original = 3 -- dense_depth
    'learning_rate': 3e-4,
...
params_global_dynamic = {
    ...
    'kernels': [48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128],  # 8, 16, 24, 32, 40,
