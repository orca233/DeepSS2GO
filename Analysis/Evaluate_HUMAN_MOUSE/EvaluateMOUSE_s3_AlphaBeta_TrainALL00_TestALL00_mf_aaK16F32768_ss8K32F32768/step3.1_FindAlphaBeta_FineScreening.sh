...
#python AlphaBeta_FindAlphaBeta.py -ncc 80 -o bp --alpha-range '0, 41, 5' --beta-range '50, 91, 5'
#python AlphaBeta_FindAlphaBeta.py -ncc 80 -o cc --alpha-range '0, 101, 2' --beta-range '0, 101, 2'
python AlphaBeta_FindAlphaBeta.py -ncc 80 -o mf --alpha-range '30, 51, 10' --beta-range '10, 31, 10'
