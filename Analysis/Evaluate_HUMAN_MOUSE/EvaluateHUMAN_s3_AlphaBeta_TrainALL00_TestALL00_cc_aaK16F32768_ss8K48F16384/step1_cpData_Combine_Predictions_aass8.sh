...
path_aa="${path_base}Evaluate_HUMAN_MOUSE/EvaluateHUMAN_ALL00_aa_DeepSS2GO_Kernel16_Filter32768_Ontsall/"
path_ss8="${path_base}Evaluate_HUMAN_MOUSE/EvaluateHUMAN_ALL00_ss8_DeepSS2GO_Kernel48_Filter16384_Ontsall/"
