...
path_aa="${path_base}output/test_CAFA3_round5_aa/DeepSS2GO_Kernel8_Filter256_Ontsall/"
path_ss8="${path_base}output/test_CAFA3_round5_ss8/DeepSS2GO_Kernel96_Filter65536_Ontsall/"
