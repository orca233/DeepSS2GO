...
params_global_constant = {
    ...
    # 是否运行哪几个step
    'run_step1_splittraintest_terms': 'T',  ################################ 特别注意 CAFA3 round 3 需要进行 step1 ##################### !!!!!!!!!!!!!!!!###############
    'run_step2_TrainTest': 'T',
    'run_step3_evaluate': 'F',  # 评价，得到Fmax, AUPR, Smin

    # 文件夹
    # dir0 = 是“非变量，不参与循环”       dir1 = 变量，参与循环
    'dir0': 'test_CAFA3_round3_aa_reverse/',  # output/dir0/ 同一批次实验的root文件夹， change -----
    ...
    'train_data': 'CAFA3',  #  只写具体物种 HUMAN, MOUSE, ARATH。。。，不用写ALL00， ['HUMAN', 'MOUSE']
    'test_data': 'CAFA3',  # ['HUMAN', 'MOUSE']
...
params_global_dynamic = {
    ...
    'kernels': [128, 120, 112, 104, 96, 88, 80, 72, 64, 56, 48, 40, 32, 24, 16, 12, 8, 4],
    'filters': [65536, 32768, 16384, 8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16]   # 不需要变成 tuple
