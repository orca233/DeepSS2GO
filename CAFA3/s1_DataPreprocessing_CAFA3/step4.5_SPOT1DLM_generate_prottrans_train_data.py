...
### FS ###  ------ 已根据CAFA3更新：------
prot_df = pd.read_pickle(path_pub_data + 'data_cafa3/CAFA3_test_data_clean_aa.pkl')  # original: swissprot_clean_ALL00_aa.pkl  'data_cafa3/CAFA3_clean_train_data_aa.pkl' 修改！！！！！！！
...
for index, row in prot_df.iterrows():
    ...
    np.save(path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_test_data/' + prot_name + "_pt.npy", features[0])
