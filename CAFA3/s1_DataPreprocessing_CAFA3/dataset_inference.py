...
class FS_Proteins_Dataset(Dataset):
    ...
    def __getitem__(self, idx):  # 不知道这个idx能不能用。。。
        ...
        one_hot_enc = one_hot(seq)
        embedding1 = np.load(os.path.join(save_path_npy, protein + "_esm.npy"))  # 原始为了swissprot
        embedding2 = np.load(os.path.join(save_path_npy, protein + "_pt.npy"))  # 原始为了swissprot

        # embedding1 = np.load(os.path.join(save_path_npy, protein + "_esm.npy"))  # 为了CAFA3
        # embedding2 = np.load(os.path.join(save_path_npy, protein + "_pt.npy"))  # 为了CAFA3
...
class FS_Proteins_Dataset_CAFA3_train_data(Dataset):
    def __init__(self, df):
        self.protein_list = df
    ...
    def __getitem__(self, idx):  # 不知道这个idx能不能用。。。
        ...
        embedding1 = np.load(os.path.join(path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_train_data/', protein + "_esm.npy"))  # 为了CAFA3
        embedding2 = np.load(os.path.join(path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_train_data/', protein + "_pt.npy"))  # 为了CAFA3
...
class FS_Proteins_Dataset_CAFA3_test_data(Dataset):
    def __init__(self, df):
        self.protein_list = df
    ...
    def __getitem__(self, idx):  # 不知道这个idx能不能用。。。
        ...
        embedding1 = np.load(os.path.join(path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_test_data/', protein + "_esm.npy"))  # 为了CAFA3
        embedding2 = np.load(os.path.join(path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_test_data/', protein + "_pt.npy"))  # 为了CAFA3
