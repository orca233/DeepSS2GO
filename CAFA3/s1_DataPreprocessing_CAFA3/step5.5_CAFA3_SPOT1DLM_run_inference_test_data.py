...
import pandas as pd
from dataset_inference import text_collate_fn, FS_Proteins_Dataset_CAFA3_test_data  # FS_Proteins_Dataset会调用inputs/*esm.npy *pt.npy
...
parser.add_argument('--save_path', default=path_redundancy + 'SPOT1DLM_results_CAFA3_test_data/', type=str, help=' define the device you want the ')  # save_path_csv
args = parser.parse_args()


### FS ###  ------ 已根据CAFA3更新：------
prot_df = pd.read_pickle(path_pub_data + 'data_cafa3/CAFA3_test_data_clean_aa.pkl')  # data_cafa3/CAFA3_clean_train_data_aa.pkl 修改！！！！！！！！！！！！！！！！

FS_test_set = FS_Proteins_Dataset_CAFA3_test_data(prot_df)  ## FS: 俺也不知道好使不。。。 看起来还OJBK
