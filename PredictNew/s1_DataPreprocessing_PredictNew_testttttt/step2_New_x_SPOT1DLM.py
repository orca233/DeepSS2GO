...
df = pd.read_pickle(path_base + 'pub_data/data_new/new_aa.pkl')  # 全集 79230
...
# output
df.to_pickle(path_base + 'pub_data/data_new/new_clean_aa.pkl')  # final  pkl = 79,020
