...
#python AlphaBeta_FindAlphaBeta.py -ncc 80 -o bp --alpha-range '0, 21, 2' --beta-range '40, 61, 2'
#python AlphaBeta_FindAlphaBeta.py -ncc 80 -o cc --alpha-range '20, 41, 2' --beta-range '20, 41, 2'
python AlphaBeta_FindAlphaBeta.py -ncc 80 -o mf --alpha-range '0, 21, 2' --beta-range '30, 51, 2'
