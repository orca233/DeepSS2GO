...
path_aa="${path_base}output/test_CAFA3_round5_aa/DeepSS2GO_Kernel24_Filter32768_Ontsall/"
path_ss8="${path_base}output/test_CAFA3_round5_ss8/DeepSS2GO_Kernel24_Filter32768_Ontsall/"
