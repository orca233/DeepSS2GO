...
@ck.option('--run-train-switch', '-rtrs', default='T', help='XX')  # step2中默认加载 run_train, 不加载 run_test。 step3 中反过来
@ck.option('--run-test-switch', '-rtes', default='F', help='XX')  # step2中默认加载 run_train, 不加载 run_test。 step3 中反过来
