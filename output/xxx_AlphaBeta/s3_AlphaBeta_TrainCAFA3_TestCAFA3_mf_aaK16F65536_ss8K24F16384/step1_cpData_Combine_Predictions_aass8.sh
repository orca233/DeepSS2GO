...
path_aa="${path_base}output/Best4PredictNew/test_TrainCAFA3_TestCAFA3_aa_DeepSS2GO_Kernel16_Filter65536_Ontsall/"
path_ss8="${path_base}output/Best4PredictNew/test_TrainCAFA3_TestCAFA3_ss8_DeepSS2GO_Kernel24_Filter16384_Ontsall/"
