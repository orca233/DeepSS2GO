...
fpath = path_pub_data + 'data_cafa3/CAFA3_train_data_clean_aa.pkl'  # new1: CAFA3_clean_train_data_aa.pkl   new2: CAFA3_clean_test_data_aa.pkl  修改！！！！！！！！！！！！！！
...
for index, row in prot_df.iterrows():
    ...
    save_path = path_base + 'redundancy/SPOT1DLM_inputs_CAFA3_train_data/' + prot_name + "_esm.npy"  # 文件太大，存在redundancy里  # 这个针对CAFA3，因为train/test已经分化
